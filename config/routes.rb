SampleOmniauth::Application.routes.draw do
  ...
  match "/add_to_cart" => "products#add_to_cart", :as => :add_to_cart
  match "/delete_session_products" => "products#delete_session_products"
